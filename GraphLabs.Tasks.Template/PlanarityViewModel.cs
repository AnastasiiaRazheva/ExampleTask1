...
{
    /// <summary> ViewModel для Planarity </summary>
    public partial class PlanarityViewModel : TaskViewModelBase<Planarity>
    {
        ...
        public static readonly DependencyProperty IsLoadingDataProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((PlanarityViewModel m) => m.IsLoadingData), 
            typeof(bool), 
            typeof(PlanarityViewModel), 
        ...
        public static readonly DependencyProperty IsMouseVerticesMovingEnabledProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((PlanarityViewModel m) => m.IsMouseVerticesMovingEnabled),
            typeof(bool),
            typeof(PlanarityViewModel),
            new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty ToolBarCommandsProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((PlanarityViewModel m) => m.ToolBarCommands),
        ...
        public static readonly DependencyProperty GivenGraphProperty =
            ...
            ExpressionUtility.NameForMember((PlanarityViewModel m) => m.GivenGraph),
            typeof(IGraph),
            typeof(PlanarityViewModel),
        ...
        public static readonly DependencyProperty VertexClickCmdProperty =
            DependencyProperty.Register("VertexClickCmd", typeof(ICommand), typeof(PlanarityViewModel), new PropertyMetadata(default(ICommand)));

        /// <summary> Загрузка silvelight-модуля выполнена </summary>
        public static readonly DependencyProperty OnLoadedCmdProperty =
            DependencyProperty.Register("OnLoadedCmd", typeof(ICommand), typeof(PlanarityViewModel), new PropertyMetadata(default(ICommand)));
