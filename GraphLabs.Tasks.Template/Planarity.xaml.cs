...
namespace GraphLabs.Tasks.Planarity
{
    ...
    public partial class Planarity : TaskViewBase
    {
        ...
        public static readonly DependencyProperty OnLoadedCommandProperty =
            DependencyProperty.Register("OnLoadedCommand", typeof(ICommand), typeof(Planarity), new PropertyMetadata(default(ICommand)));
        ...
        public static DependencyProperty VertVisProperty =
            DependencyProperty.Register("VertVis", typeof(ReadOnlyCollection<Vertex>), typeof(Planarity), new PropertyMetadata(default(ReadOnlyCollection<Vertex>)));
